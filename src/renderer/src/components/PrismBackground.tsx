    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#0A0A0F]">
      ...
      <div
        className={clsx(
          ...
          isActive && 'animate-slow-pulse scale-110 from-accent-primary/30 to-accent-secondary/20'
        )}
      />
      <div
        className={clsx(
      ...
      <div
        className={clsx(
          'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[40vh] bg-accent-primary/10 blur-[120px] rounded-full transition-all duration-[1500ms] ease-in-out',
