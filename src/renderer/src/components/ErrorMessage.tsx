      ...
      >
        ...
        <div className="flex items-center">
          <button
            ...
            className="flex-1 px-4 py-3 flex items-center justify-between gap-3 text-left"
          >
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-status-error/20 text-status-error shrink-0">
                <AlertCircle size={18} />
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] uppercase tracking-widest font-black text-status-error/70 leading-none mb-1">
                  Prism Exception
                </span>
                <span className="text-sm font-semibold text-text-primary/90">
                  Error {errorCode}: {summary}
                </span>
              </div>
            </div>
