...
export function RenderChatHistory({
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-2xl bg-white/[0.03] backdrop-blur-xl p-4 shadow-[0_1px_6px_rgba(0,0,0,0.22)] hover:bg-white/[0.055] transition-all duration-300 w-full max-w-md animate-fade-in my-1">
