...
| ------------- | ------------------------ | --------------------------------------------------------------------------- |
| **Prism 5**   | `gemini-3.5-flash`       | **(Recommended)** Flagship intelligence for complex work and fast execution |
| **Prism 4.3** | `gemma-4-31b-it`         | Deep reasoning for heavier tasks and careful planning                       |
| **Prism 4.2** | `gemma-4-26b-a4b-it`     | Balanced automation for multi-step desktop workflows                        |
| **Prism 4.1** | `gemini-3-flash-preview` | Fast intelligence for responsive everyday assistance                        |
| **Prism 4**   | `gemini-3.1-flash-lite`  | Lightweight assistance for simple daily tasks                               |
