...
| ---------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------ |
| **Prism 6 Dense**      | `gemini-3.5-flash` | Deep debugging of large codebases, dense information processing, and complex logic.                          |
| **Prism 6 Dragon**     | `gemini-3.5-flash` | In-depth research, massive agent orchestration, and information gathering.                                   |
| **Prism 6 Fast**       | `gemini-3.5-flash` | Complex tasks involving automation, orchestration, and raw code with low latency.                            |
| **Prism 6 Fast-Old**   | `gemini-3.5-flash` | Speed-focused assistant for simple day-to-day tasks, automation, and orchestration.                          |
| **Prism 6 Super-Fast** | `gemini-3.5-flash` | **(Default)** Ultra-fast execution and extremely low latency for daily assistance and coding.                |
